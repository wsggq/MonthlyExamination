package com.bwie.ggq.monthlyexamination.utils;

import com.bwie.ggq.monthlyexamination.common.Api;
import com.bwie.ggq.monthlyexamination.common.Constant;
...
public class Retrofit_RXJava {
    ...
    public Api getInterface(){
        return mInterface==null ? configRetrofit(Api.class):mInterface;
    }
